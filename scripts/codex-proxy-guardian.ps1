...
$script:DefaultConfig = @{
    ...
    directDomains         = @('*.deepseek.com', '*.qwen.ai', '*.dashscope.aliyuncs.com', '*.moonshot.cn', '*.bigmodel.cn', '*.siliconflow.cn', '*.minimaxi.com', '*.api.volces.com', '*.xfyun.cn', '*.stepfun.com', '*.lingyiwanwu.com', '*.baichuan-ai.com', '*.longcat.chat')
